...
class Main extends GraphToArray
{
    ...
    {
        // DAPATKAN KOORDINAT POSISI AWAL / POSISI TUJUAN
    ...
    /**
     * GAMBAR JALUR SHORTEST PATH & RUTENYA
    ...
    public function drawRoute($shortest_path)
    {
        ...
        // CARI RUTE YANG LEWAT JALUR SHORTEST PATH

        // return
        $return_json = ['jalur_shortest_path' => $semua_latlng, 'node' => $shortest_path];
